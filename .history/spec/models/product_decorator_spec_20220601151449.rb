...
RSpec.describe Potepan::ProductDecorator, type: :model do
  describe "related_products" do
    ...
    let!(:duplicate_product){ create :product, taxons: [taxon1] }

    context "related_productsに関連商品が含まれている" do
      it "関連商品が含まれていること" do
      binding.pry
        expect(related_products[0..3]).to include products
      end

      it "関連商品が重複していないこと" do
      binding.pry
        expect(related_products.pluck(:id)).to_not eq duplicate_product.pluck(:id)
      end
