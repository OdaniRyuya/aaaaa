...
RSpec.feature "CategoriesFeatures", type: :feature do
  ...
  let!(:categories) { create(:taxon, name: "test_taxon", taxonomy: taxonomy, parent: taxonomy.root) }
  let!(:shirts) { create(:taxon, name: "test_taxonomy", taxonomy: taxonomy, parent: taxon) }
